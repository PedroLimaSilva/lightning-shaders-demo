...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/@lightningjs/core/src/tree/StageUtils.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@lightningjs/core/src/tree/Utils.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@lightningjs/core/src/tree/Base.mjs":[function(require,module,exports) {
"use strict";
...
class Base {
  ...
  static patchObject(obj, settings) {
    if (!_Utils.default.isObjectLiteral(settings)) {
  ...
  static patchObjectProperty(obj, name, value) {
    ...
    if (name.charAt(0) === "_") {
      ...
      if (_Utils.default.isFunction(value) && value.__local) {
...
},{"./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/flex/layout/SpacingCalculator.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = SpacingCalculator;
},{}],"node_modules/@lightningjs/core/src/flex/layout/ContentAligner.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _SpacingCalculator = _interopRequireDefault(require("./SpacingCalculator.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ContentAligner {
  ...
  align() {
    ...
    const {
      spacingBefore,
      spacingBetween
    } = this._getSpacing(remainingSpace);
  ...
  _getSpacing(remainingSpace) {
    ...
    return _SpacingCalculator.default.getSpacing(mode, numberOfItems, remainingSpace);
  }
}
exports.default = ContentAligner;
},{"./SpacingCalculator.mjs":"node_modules/@lightningjs/core/src/flex/layout/SpacingCalculator.mjs"}],"node_modules/@lightningjs/core/src/flex/FlexUtils.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = FlexUtils;
},{}],"node_modules/@lightningjs/core/src/flex/layout/line/SizeShrinker.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = SizeShrinker;
},{}],"node_modules/@lightningjs/core/src/flex/layout/line/SizeGrower.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = SizeGrower;
},{}],"node_modules/@lightningjs/core/src/flex/layout/line/ItemPositioner.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = ItemPositioner;
},{"../SpacingCalculator.mjs":"node_modules/@lightningjs/core/src/flex/layout/SpacingCalculator.mjs"}],"node_modules/@lightningjs/core/src/flex/layout/line/ItemAligner.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = ItemAligner;
},{}],"node_modules/@lightningjs/core/src/flex/layout/line/LineLayout.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _SizeShrinker = _interopRequireDefault(require("./SizeShrinker.mjs"));
var _SizeGrower = _interopRequireDefault(require("./SizeGrower.mjs"));
var _ItemPositioner = _interopRequireDefault(require("./ItemPositioner.mjs"));
var _ItemAligner = _interopRequireDefault(require("./ItemAligner.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class LineLayout {
  ...
  _growItemSizes(amount) {
    const grower = new _SizeGrower.default(this);
    grower.grow(amount);
    this._availableSpace -= grower.getGrownSize();
  }
  _shrinkItemSizes(amount) {
    const shrinker = new _SizeShrinker.default(this);
    shrinker.shrink(amount);
    this._availableSpace += shrinker.getShrunkSize();
  }
  setItemPositions() {
    const positioner = new _ItemPositioner.default(this);
    positioner.position();
  }
  createItemAligner() {
    return new _ItemAligner.default(this);
  }
  _calcLayoutInfo() {
...
},{"./SizeShrinker.mjs":"node_modules/@lightningjs/core/src/flex/layout/line/SizeShrinker.mjs","./SizeGrower.mjs":"node_modules/@lightningjs/core/src/flex/layout/line/SizeGrower.mjs","./ItemPositioner.mjs":"node_modules/@lightningjs/core/src/flex/layout/line/ItemPositioner.mjs","./ItemAligner.mjs":"node_modules/@lightningjs/core/src/flex/layout/line/ItemAligner.mjs"}],"node_modules/@lightningjs/core/src/flex/layout/LineLayouter.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _LineLayout = _interopRequireDefault(require("./line/LineLayout.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class LineLayouter {
  ...
  _layoutLine(startIndex, endIndex) {
    ...
    const line = new _LineLayout.default(this._layout, startIndex, endIndex, availableSpace);
    line.performLayout();
...
exports.default = LineLayouter;
},{"./line/LineLayout.mjs":"node_modules/@lightningjs/core/src/flex/layout/line/LineLayout.mjs"}],"node_modules/@lightningjs/core/src/flex/layout/ItemCoordinatesUpdater.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _FlexUtils = _interopRequireDefault(require("../FlexUtils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ItemCoordinatesUpdater {
  ...
  _finalizeRoot() {
    ...
    let x = _FlexUtils.default.getAxisLayoutPos(item, true);
    let y = _FlexUtils.default.getAxisLayoutPos(item, false);
    let w = _FlexUtils.default.getAxisLayoutSize(item, true);
    let h = _FlexUtils.default.getAxisLayoutSize(item, false);
...
exports.default = ItemCoordinatesUpdater;
},{"../FlexUtils.mjs":"node_modules/@lightningjs/core/src/flex/FlexUtils.mjs"}],"node_modules/@lightningjs/core/src/flex/layout/FlexLayout.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _ContentAligner = _interopRequireDefault(require("./ContentAligner.mjs"));
var _FlexUtils = _interopRequireDefault(require("../FlexUtils.mjs"));
var _LineLayouter = _interopRequireDefault(require("./LineLayouter.mjs"));
var _ItemCoordinatesUpdater = _interopRequireDefault(require("./ItemCoordinatesUpdater.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class FlexLayout {
  constructor(flexContainer) {
    ...
    this._lineLayouter = new _LineLayouter.default(this);
  ...
  updateItemCoords() {
    const updater = new _ItemCoordinatesUpdater.default(this);
    updater.finalize();
  }
   ...
   */
  _layoutCrossAxis() {
    const aligner = new _ContentAligner.default(this);
    aligner.init();
  ...
  _hasFixedMainAxisBasis() {
    return !_FlexUtils.default.isZeroAxisSize(this.item, this._horizontal);
  }
  ...
  _getHorizontalPadding() {
    return _FlexUtils.default.getTotalPadding(this.item, true);
  }
  _getVerticalPadding() {
    return _FlexUtils.default.getTotalPadding(this.item, false);
  }
  _getHorizontalPaddingOffset() {
    return _FlexUtils.default.getPaddingOffset(this.item, true);
  }
  _getVerticalPaddingOffset() {
    return _FlexUtils.default.getPaddingOffset(this.item, false);
  }
  _getMainAxisBasis() {
    return _FlexUtils.default.getRelAxisSize(this.item, this._horizontal);
  }
  _getCrossAxisBasis() {
    return _FlexUtils.default.getRelAxisSize(this.item, !this._horizontal);
  }
  ...
  get mainAxisSize() {
    return _FlexUtils.default.getAxisLayoutSize(this.item, this._horizontal);
  }
  get crossAxisSize() {
    return _FlexUtils.default.getAxisLayoutSize(this.item, !this._horizontal);
  }
  set mainAxisSize(v) {
    _FlexUtils.default.setAxisLayoutSize(this.item, this._horizontal, v);
  }
  set crossAxisSize(v) {
    _FlexUtils.default.setAxisLayoutSize(this.item, !this._horizontal, v);
  }
...
},{"./ContentAligner.mjs":"node_modules/@lightningjs/core/src/flex/layout/ContentAligner.mjs","../FlexUtils.mjs":"node_modules/@lightningjs/core/src/flex/FlexUtils.mjs","./LineLayouter.mjs":"node_modules/@lightningjs/core/src/flex/layout/LineLayouter.mjs","./ItemCoordinatesUpdater.mjs":"node_modules/@lightningjs/core/src/flex/layout/ItemCoordinatesUpdater.mjs"}],"node_modules/@lightningjs/core/src/flex/FlexContainer.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Base = _interopRequireDefault(require("../tree/Base.mjs"));
var _FlexLayout = _interopRequireDefault(require("./layout/FlexLayout.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class FlexContainer {
  constructor(item) {
    this._item = item;
    this._layout = new _FlexLayout.default(this);
  ...
  patch(settings) {
    _Base.default.patchObject(this, settings);
  }
}
...
},{"../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","./layout/FlexLayout.mjs":"node_modules/@lightningjs/core/src/flex/layout/FlexLayout.mjs"}],"node_modules/@lightningjs/core/src/flex/FlexItem.mjs":[function(require,module,exports) {
"use strict";
...
var _Base = _interopRequireDefault(require("../tree/Base.mjs"));
var _FlexUtils = _interopRequireDefault(require("./FlexUtils.mjs"));
var _FlexContainer = _interopRequireDefault(require("./FlexContainer.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class FlexItem {
  ...
  set alignSelf(v) {
    ...
    if (v === undefined) {
      ...
      if (_FlexContainer.default.ALIGN_ITEMS.indexOf(v) === -1) {
        throw new Error("Unknown alignSelf, options: " + _FlexContainer.default.ALIGN_ITEMS.join(","));
      }
      this._alignSelf = v;
    }
    this._changed();
  ...
  _resetHorizontalAxisLayoutSize() {
    let w = _FlexUtils.default.getRelAxisSize(this.item, true);
    if (this._minWidth) {
    ...
    _FlexUtils.default.setAxisLayoutSize(this.item, true, w);
  }
  _resetVerticalAxisLayoutSize() {
    let h = _FlexUtils.default.getRelAxisSize(this.item, false);
    if (this._minHeight) {
    ...
    _FlexUtils.default.setAxisLayoutSize(this.item, false, h);
  }
  ...
  _getMainAxisMinSize() {
    return _FlexUtils.default.getAxisMinSize(this.item, this.ctr._horizontal);
  }
  _getCrossAxisMinSize() {
    return _FlexUtils.default.getAxisMinSize(this.item, !this.ctr._horizontal);
  }
  _getMainAxisLayoutSize() {
    return _FlexUtils.default.getAxisLayoutSize(this.item, this.ctr._horizontal);
  }
  _getMainAxisLayoutPos() {
    return _FlexUtils.default.getAxisLayoutPos(this.item, this.ctr._horizontal);
  }
  _setMainAxisLayoutPos(pos) {
    return _FlexUtils.default.setAxisLayoutPos(this.item, this.ctr._horizontal, pos);
  }
  ...
  _resizeCrossAxis(size) {
    return _FlexUtils.default.resizeAxis(this.item, !this.ctr._horizontal, size);
  }
  _resizeMainAxis(size) {
    return _FlexUtils.default.resizeAxis(this.item, this.ctr._horizontal, size);
  }
  _getMainAxisPadding() {
    return _FlexUtils.default.getTotalPadding(this.item, this.ctr._horizontal);
  }
  _getCrossAxisPadding() {
    return _FlexUtils.default.getTotalPadding(this.item, !this.ctr._horizontal);
  }
  _getMainAxisMargin() {
    return _FlexUtils.default.getTotalMargin(this.item, this.ctr._horizontal);
  }
  _getCrossAxisMargin() {
    return _FlexUtils.default.getTotalMargin(this.item, !this.ctr._horizontal);
  }
  _getHorizontalMarginOffset() {
    return _FlexUtils.default.getMarginOffset(this.item, true);
  }
  _getVerticalMarginOffset() {
    return _FlexUtils.default.getMarginOffset(this.item, false);
  }
  ...
  _hasFixedCrossAxisSize() {
    return !_FlexUtils.default.isZeroAxisSize(this.item, !this.ctr._horizontal);
  }
...
},{"../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","./FlexUtils.mjs":"node_modules/@lightningjs/core/src/flex/FlexUtils.mjs","./FlexContainer.mjs":"node_modules/@lightningjs/core/src/flex/FlexContainer.mjs"}],"node_modules/@lightningjs/core/src/flex/FlexTarget.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _FlexContainer = _interopRequireDefault(require("./FlexContainer.mjs"));
var _FlexItem = _interopRequireDefault(require("./FlexItem.mjs"));
var _FlexUtils = _interopRequireDefault(require("./FlexUtils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
...
class FlexTarget {
  ...
  _enableFlex() {
    this._flex = new _FlexContainer.default(this);
    this._checkEnabled();
  ...
  _ensureFlexItem() {
    if (!this._flexItem) {
      this._flexItem = new _FlexItem.default(this);
    }
  }
  _checkEnabled() {
  ...
  setLayout(x, y, w, h) {
    ...
    if (this.funcX) {
      originalX = this.funcX(_FlexUtils.default.getParentAxisSizeWithPadding(this, true));
    }
    if (this.funcY) {
      originalY = this.funcY(_FlexUtils.default.getParentAxisSizeWithPadding(this, false));
    }
...
exports.default = FlexTarget;
},{"./FlexContainer.mjs":"node_modules/@lightningjs/core/src/flex/FlexContainer.mjs","./FlexItem.mjs":"node_modules/@lightningjs/core/src/flex/FlexItem.mjs","./FlexUtils.mjs":"node_modules/@lightningjs/core/src/flex/FlexUtils.mjs"}],"node_modules/@lightningjs/core/src/tree/TextureSource.mjs":[function(require,module,exports) {
"use strict";
...
TextureSource.id = 1;
},{"./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/tree/core/ElementTexturizer.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _TextureSource = _interopRequireDefault(require("../TextureSource.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ElementTexturizer {
  ...
  _getTextureSource() {
    if (!this._resultTextureSource) {
      this._resultTextureSource = new _TextureSource.default(this._element.stage.textureManager);
...
exports.default = ElementTexturizer;
},{"../TextureSource.mjs":"node_modules/@lightningjs/core/src/tree/TextureSource.mjs"}],"node_modules/@lightningjs/core/src/tree/core/ElementCore.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _FlexTarget = _interopRequireDefault(require("../../flex/FlexTarget.mjs"));
var _ElementTexturizer = _interopRequireDefault(require("./ElementTexturizer.mjs"));
var _Utils = _interopRequireDefault(require("../Utils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
...
class ElementCore {
  ...
  set offsetX(v) {
    if (_Utils.default.isFunction(v)) {
      this.funcX = v;
    } else {
      this._disableFuncX();
      if (this.hasFlexLayout()) {
  ...
  get texturizer() {
    if (!this._texturizer) {
      this._texturizer = new _ElementTexturizer.default(this);
    }
  ...
  _ensureLayout() {
    if (!this._layout) {
      this._layout = new _FlexTarget.default(this);
    }
  }
  disableFlexLayout() {
    this._triggerRecalcTranslate();
...
},{"../../flex/FlexTarget.mjs":"node_modules/@lightningjs/core/src/flex/FlexTarget.mjs","./ElementTexturizer.mjs":"node_modules/@lightningjs/core/src/tree/core/ElementTexturizer.mjs","../Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/EventEmitter.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@lightningjs/core/src/tree/Shader.mjs":[function(require,module,exports) {
"use strict";
...
class Shader {
  ...
  static create(stage, v) {
    let shader;
    if (_Utils.default.isObjectLiteral(v)) {
      if (v.type) {
      ...
      if (shader) {
        _Base.default.patchObject(shader, v);
      }
    } else if (v === null) {
...
},{"./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/tree/Texture.mjs":[function(require,module,exports) {
"use strict";
...
Texture.id = 0;
},{"./Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/textures/ImageTexture.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Texture = _interopRequireDefault(require("../tree/Texture.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ImageTexture extends _Texture.default {
  constructor(stage) {
    super(stage);
    this._src = undefined;
...
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/textures/TextTextureRenderer.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _StageUtils = _interopRequireDefault(require("../tree/StageUtils.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class TextTextureRenderer {
  ...
  setFontProperties() {
    this._context.font = _Utils.default.isSpark ? this._stage.platform.getFontSetting(this) : this._getFontSetting();
  ...
  _load() {
    if (_Utils.default.isWeb && document.fonts) {
  ...
  draw() {
    ...
    if (!loadPromise) {
      return _Utils.default.isSpark ? this._stage.platform.drawText(this) : this._draw();
    } else {
  ...
  _draw() {
    ...
    if (this._settings.highlight) {
      ...
      this._context.fillStyle = _StageUtils.default.getRgbaString(color);
    ...
    if (this._settings.shadow) {
      ...
      this._context.shadowColor = _StageUtils.default.getRgbaString(this._settings.shadowColor);
      this._context.shadowOffsetX = this._settings.shadowOffsetX * precision;
      this._context.shadowOffsetY = this._settings.shadowOffsetY * precision;
      this._context.shadowBlur = this._settings.shadowBlur * precision;
    }
    this._context.fillStyle = _StageUtils.default.getRgbaString(this._settings.textColor);
...
exports.default = TextTextureRenderer;
},{"../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/textures/TextTextureRendererAdvanced.mjs":[function(require,module,exports) {
"use strict";
...
class TextTextureRendererAdvanced {
  ...
  setFontProperties() {
    const font = _Utils.default.isSpark ? this._stage.platform.getFontSetting(this) : this._getFontSetting();
  ...
  _draw() {
    ...
    if (renderInfo.highlight) {
      ...
      this._context.fillStyle = _StageUtils.default.getRgbaString(hlColor);
    ...
    // Draw text
    const defaultColor = _StageUtils.default.getRgbaString(this._settings.textColor);
  ...
  parse(tokens) {
    let italic = 0;
    let bold = 0;
    let colorStack = [_StageUtils.default.getRgbaString(this._settings.textColor)];
    let color = 0;
    ...
    return tokens.map(t => {
      if (t == '<i>') {
        ...
        colorStack.push(_StageUtils.default.getRgbaString(parseInt(colorRegexp.exec(t).groups['color'])));
        color += 1;
        t = '';
      }
      return {
    ...
    if (!word.letters) {
      while (true) {
        const {
          breakIndex,
          truncWordWidth
        } = this._getBreakIndex(text, width);
        parts.push({
          ...word
        });
...
exports.default = TextTextureRendererAdvanced;
},{"../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/textures/TextTexture.mjs":[function(require,module,exports) {
"use strict";
...
var _Texture = _interopRequireDefault(require("../tree/Texture.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _TextTextureRenderer = _interopRequireDefault(require("./TextTextureRenderer.mjs"));
var _TextTextureRendererAdvanced = _interopRequireDefault(require("./TextTextureRendererAdvanced.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class TextTexture extends _Texture.default {
  constructor(stage) {
    super(stage);
  ...
  static renderer(stage, canvas, settings) {
    if (this.advancedRenderer) {
      return new _TextTextureRendererAdvanced.default(stage, canvas, settings);
    } else {
      return new _TextTextureRenderer.default(stage, canvas, settings);
    }
  }
  get text() {
    return this._text;
  ...
  _getSourceLoader() {
    ...
    return function (cb) {
      ...
      const renderer = args.advancedRenderer ? new _TextTextureRendererAdvanced.default(this.stage, canvas, args) : new _TextTextureRenderer.default(this.stage, canvas, args);
      ...
      if (_Utils.default.isBoolean(sharpCfg)) {
        sharpen = sharpCfg;
      } else if (_Utils.default.isObject(sharpCfg)) {
...
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./TextTextureRenderer.mjs":"node_modules/@lightningjs/core/src/textures/TextTextureRenderer.mjs","./TextTextureRendererAdvanced.mjs":"node_modules/@lightningjs/core/src/textures/TextTextureRendererAdvanced.mjs"}],"node_modules/@lightningjs/core/src/textures/SourceTexture.mjs":[function(require,module,exports) {
"use strict";
...
class SourceTexture extends _Texture.default {
  constructor(stage) {
    super(stage);
...
exports.default = SourceTexture;
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/animation/Transition.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _EventEmitter = _interopRequireDefault(require("../EventEmitter.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Transition extends _EventEmitter.default {
...
},{"../EventEmitter.mjs":"node_modules/@lightningjs/core/src/EventEmitter.mjs"}],"node_modules/@lightningjs/core/src/tree/ObjectList.mjs":[function(require,module,exports) {
"use strict";
...
class ObjectList {
  ...
  addAt(item, index) {
    if (index >= 0 && index <= this._items.length) {
      ...
      if (_Utils.default.isObjectLiteral(item)) {
        const o = item;
  ...
  a(o) {
    if (_Utils.default.isObjectLiteral(o)) {
  ...
  _setByArray(array) {
    ...
    for (let i = 0, n = array.length; i < n; i++) {
      ...
      if (this.isItem(s)) {
        ...
        if (_Utils.default.isObjectLiteral(s)) {
          c.patch(s);
        }
        newItems.push(c);
      }
...
},{"./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/tree/ElementChildList.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _ObjectList = _interopRequireDefault(require("./ObjectList.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ElementChildList extends _ObjectList.default {
  constructor(element) {
    super();
    this._element = element;
  }
...
exports.default = ElementChildList;
},{"./ObjectList.mjs":"node_modules/@lightningjs/core/src/tree/ObjectList.mjs"}],"node_modules/@lightningjs/core/src/tree/Element.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _StageUtils = _interopRequireDefault(require("./StageUtils.mjs"));
var _ElementCore = _interopRequireDefault(require("./core/ElementCore.mjs"));
var _Base = _interopRequireDefault(require("./Base.mjs"));
var _Utils = _interopRequireDefault(require("./Utils.mjs"));
var _EventEmitter = _interopRequireDefault(require("../EventEmitter.mjs"));
var _Shader = _interopRequireDefault(require("./Shader.mjs"));
var _Texture = _interopRequireDefault(require("./Texture.mjs"));
var _ImageTexture = _interopRequireDefault(require("../textures/ImageTexture.mjs"));
var _TextTexture = _interopRequireDefault(require("../textures/TextTexture.mjs"));
var _SourceTexture = _interopRequireDefault(require("../textures/SourceTexture.mjs"));
var _Transition = _interopRequireDefault(require("../animation/Transition.mjs"));
var _ElementChildList = _interopRequireDefault(require("./ElementChildList.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Element {
  constructor(stage) {
    ...
    this._hasEventListeners = false;
    this.__core = new _ElementCore.default(this);
  ...
  set ref(ref) {
    if (this.__ref !== ref) {
      ...
      if (!_Utils.default.isUcChar(charcode)) {
  ...
  set texture(v) {
    ...
    if (_Utils.default.isObjectLiteral(v)) {
      ...
      if (texture) {
        _Base.default.patchObject(texture, v);
      }
    } else if (!v) {
      texture = null;
    } else {
      if (v.isTexture) {
        ...
        texture = new _SourceTexture.default(this.stage);
  ...
  onDimensionsChanged(w, h) {
    if (this.texture instanceof _TextTexture.default) {
      this.texture.w = w;
      this.texture.h = h;
      this.w = w;
      this.h = h;
  ...
  _unsetTagsParent() {
    ...
    if (this.__treeTags) {
      if (!this.__tagRoot) {
        tags = _Utils.default.iteratorToArray(this.__treeTags.keys());
        n = tags.length;
        if (n > 0) {
          for (let i = 0; i < n; i++) {
  ...
  _getByTag(tag) {
    ...
    return t ? _Utils.default.setToArray(t) : [];
  }
  getTags() {
  ...
  addTag(tag) {
    if (tag.indexOf(' ') === -1) {
      if (_Utils.default.isUcChar(tag.charCodeAt(0))) {
  ...
  stag(tag, settings) {
    ...
    let n = t.length;
    for (let i = 0; i < n; i++) {
      _Base.default.patchObject(t[i], settings);
    }
  }
  get tagRoot() {
  ...
  static getPrettyString(obj, indent) {
    ...
    if (children) {
      let childStr = "";
      if (_Utils.default.isObjectLiteral(children)) {
  ...
  getNonDefaults() {
    ...
    if (this.shader && _Utils.default.isFunction(this.shader.getNonDefaults)) {
  ...
  get _children() {
    if (!this.__childList) {
      this.__childList = new _ElementChildList.default(this, false);
    }
  ...
  get src() {
    if (this.texture && this.texture instanceof _ImageTexture.default) {
  ...
  set src(v) {
    const texture = new _ImageTexture.default(this.stage);
    texture.src = v;
  ...
  enableTextTexture() {
    if (!this.texture || !(this.texture instanceof _TextTexture.default)) {
      this.texture = new _TextTexture.default(this.stage);
  ...
  set shader(v) {
    if (_Utils.default.isObjectLiteral(v) && !v.type) {
      // Setting properties on an existing shader.
      if (this.shader) {
        this.shader.patch(v);
      }
    } else {
      const shader = _Shader.default.create(this.stage, v);
  ...
  patch(settings) {
    ...
    for (let i = 0, n = paths.length; i < n; i++) {
      ...
      if (_Utils.default.isUcChar(firstCharCode)) {
        // Ref.
        ...
        if (!child) {
          if (v !== undefined) {
            ...
            if (_Utils.default.isObjectLiteral(v)) {
              ...
              c.patch(v);
            } else if (_Utils.default.isObject(v)) {
              c = v;
            }
            if (c.isElement) {
              c.ref = path;
          ...
          } else if (_Utils.default.isObjectLiteral(v)) {
            child.patch(v);
          } else if (v.isElement) {
        ...
        // Property.
        _Base.default.patchObjectProperty(this, path, v);
      }
    }
  }
  _throwError(message) {
  ...
  _getTransition(property) {
    ...
    if (!t) {
      ...
      t = new _Transition.default(this.stage.transitions, this.stage.transitions.defaultTransitionSettings, this, property);
    } else if (t.isTransitionSettings) {
      // Upgrade to 'real' transition.
      t = new _Transition.default(this.stage.transitions, t, this, property);
    }
  ...
  static getMerger(property) {
    if (Element.isColorProperty(property)) {
      return _StageUtils.default.mergeColors;
    } else {
      return _StageUtils.default.mergeNumbers;
    }
  }
  toJSON() {
  ...
  static getProperties(element) {
    const props = {};
    const list = ["alpha", "active", "attached", "boundsMargin", "color", "clipping", "enabled", "h", "id", "isComponent", "mount", "mountY", "mountX", "pivot", "pivotX", "pivotY", "ref", "renderOfScreen", "renderToTexture", "scale", "scaleX", "scaleY", "state", "tag", "visible", "w", "x", "y", "zIndex", "!!flex", "!!flexItem", "hasFocus()", "hasFinalFocus()"];
    let n = list.length;
    while (n--) {
      let key = list[n];
      const getBoolean = /^!{2}/;
...
_EventEmitter.default.addAsMixin(Element);
...
},{"./StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./core/ElementCore.mjs":"node_modules/@lightningjs/core/src/tree/core/ElementCore.mjs","./Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../EventEmitter.mjs":"node_modules/@lightningjs/core/src/EventEmitter.mjs","./Shader.mjs":"node_modules/@lightningjs/core/src/tree/Shader.mjs","./Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs","../textures/ImageTexture.mjs":"node_modules/@lightningjs/core/src/textures/ImageTexture.mjs","../textures/TextTexture.mjs":"node_modules/@lightningjs/core/src/textures/TextTexture.mjs","../textures/SourceTexture.mjs":"node_modules/@lightningjs/core/src/textures/SourceTexture.mjs","../animation/Transition.mjs":"node_modules/@lightningjs/core/src/animation/Transition.mjs","./ElementChildList.mjs":"node_modules/@lightningjs/core/src/tree/ElementChildList.mjs"}],"node_modules/@lightningjs/core/src/application/StateMachine.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@lightningjs/core/src/application/Component.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Element = _interopRequireDefault(require("../tree/Element.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _StateMachine = _interopRequireDefault(require("./StateMachine.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
 ...
 */
class Component extends _Element.default {
  constructor(stage, properties) {
    super(stage);

    // Encapsulate tags to prevent leaking.
    this.tagRoot = true;
    if (_Utils.default.isObjectLiteral(properties)) {
  ...
  __start() {
    _StateMachine.default.setupStateMachine(this);
  ...
  __bindProperty(propObj, targetObj, targetProp) {
    ...
    for (let i = 0; i < propDependencies.length; i++) {
      ...
      if (!this.hasOwnProperty(propName)) {
        this[`__prop_bindings_${propName}`] = [{
          __obj: obj,
          __prop: prop,
          __func: func
        }];
        Object.defineProperty(this, propName, {
          set: value => {
            ...
            for (const {
              ...
              __prop,
              __func
            } of this[`__prop_bindings_${propName}`]) {
        ...
        this[`__prop_bindings_${propName}`].push({
          __obj: obj,
          __prop: prop,
          __func: func
        });
  ...
  static parseTemplateRec(obj, context, cursor) {
    ...
    keys.forEach(key => {
      let value = obj[key];
      if (_Utils.default.isUcChar(key.charCodeAt(0))) {
        // Value must be expanded as well.
        if (_Utils.default.isObjectLiteral(value)) {
          // Ref.
          const childCursor = `r${key.replace(/[^a-z0-9]/gi, "") + context.rid}`;
          let type = value.type ? value.type : _Element.default;
          if (type === _Element.default) {
        ...
        if (key === "text") {
        ...
        } else if (key === "shader" && _Utils.default.isObjectLiteral(value)) {
          const shaderCursor = `${cursor}["shader"]`;
          store.push(value);
          loc.push(`${cursor}["${key}"] = store[${store.length - 1}]`);
          this.parsePropertyBindings(value, context, shaderCursor);
        } else if (key === "texture" && _Utils.default.isObjectLiteral(value)) {
        ...
        } else if (_Utils.default.isObjectLiteral(value) && value.__propertyBinding === true) {
          store.push(value);
          loc.push(`element.__bindProperty(store[${store.length - 1}], ${cursor}, "${key}")`);
        } else {
          // Property;
          ...
          } else if (_Utils.default.isBoolean(value)) {
            loc.push(`${cursor}["${key}"] = ${value ? "true" : "false"}`);
          } else if (_Utils.default.isObject(value) || Array.isArray(value)) {
            // Dynamic assignment.
    ...
    keys.forEach(key => {
      if (key !== "type") {
        ...
        if (_Utils.default.isNumber(value)) {
          ...
          loc.push(`${cursor}["${key}"] = ${value ? "true" : "false"}`);
        } else if (_Utils.default.isObject(value) && value.__propertyBinding === true) {
          store.push(value);
          loc.push(`element.__bindProperty(store[${store.length - 1}], ${cursor}, "${key}")`);
        } else if (_Utils.default.isObject(value) || Array.isArray(value)) {
          // Dynamic assignment.
  ...
  static parsePropertyBindings(obj, context, cursor) {
    ...
    keys.forEach(key => {
      if (key !== "type") {
        const value = obj[key];
        if (_Utils.default.isObjectLiteral(value) && value.__propertyBinding === true) {
          store.push(value);
          loc.push(`element.__bindProperty(store[${store.length - 1}], ${cursor}, "${key}")`);
        }
      }
    ...
    if (signalParent) {
      if (this.__signals) {
        ...
        if (fireEvent) {
          ...
          if (_Utils.default.isFunction(fireEvent)) {
...
},{"../tree/Element.mjs":"node_modules/@lightningjs/core/src/tree/Element.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./StateMachine.mjs":"node_modules/@lightningjs/core/src/application/StateMachine.mjs"}],"node_modules/@lightningjs/core/src/tree/core/CoreQuadList.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = CoreQuadList;
},{}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreQuadList.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _CoreQuadList = _interopRequireDefault(require("../../tree/core/CoreQuadList.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLCoreQuadList extends _CoreQuadList.default {
  constructor(ctx) {
    super(ctx);
...
exports.default = WebGLCoreQuadList;
},{"../../tree/core/CoreQuadList.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreQuadList.mjs"}],"node_modules/@lightningjs/core/src/tree/core/CoreQuadOperation.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = CoreQuadOperation;
},{}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreQuadOperation.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _CoreQuadOperation = _interopRequireDefault(require("../../tree/core/CoreQuadOperation.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLCoreQuadOperation extends _CoreQuadOperation.default {
  constructor(ctx, shader, shaderOwner, renderTextureInfo, scissor, index) {
...
exports.default = WebGLCoreQuadOperation;
},{"../../tree/core/CoreQuadOperation.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreQuadOperation.mjs"}],"node_modules/@lightningjs/core/src/tree/core/CoreRenderExecutor.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = CoreRenderExecutor;
},{}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreRenderExecutor.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _CoreRenderExecutor = _interopRequireDefault(require("../../tree/core/CoreRenderExecutor.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLCoreRenderExecutor extends _CoreRenderExecutor.default {
  constructor(ctx) {
    super(ctx);
    this.gl = this.ctx.stage.gl;
    this.init();
...
exports.default = WebGLCoreRenderExecutor;
},{"../../tree/core/CoreRenderExecutor.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreRenderExecutor.mjs"}],"node_modules/@lightningjs/core/src/tree/core/CoreRenderState.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = CoreRenderState;
},{}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShaderProgram.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = WebGLShaderProgram;
},{}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _WebGLShaderProgram = _interopRequireDefault(require("./WebGLShaderProgram.mjs"));
var _Shader = _interopRequireDefault(require("../../tree/Shader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLShader extends _Shader.default {
  constructor(ctx) {
    super(ctx);
    const stage = ctx.stage;
    this._program = stage.renderer.shaderPrograms.get(this.constructor);
    if (!this._program) {
      this._program = new _WebGLShaderProgram.default(this.constructor.vertexShaderSource, this.constructor.fragmentShaderSource);
...
},{"./WebGLShaderProgram.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShaderProgram.mjs","../../tree/Shader.mjs":"node_modules/@lightningjs/core/src/tree/Shader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _WebGLShader = _interopRequireDefault(require("../WebGLShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class DefaultShader extends _WebGLShader.default {
  enableAttribs() {
...
`;
},{"../WebGLShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/Renderer.mjs":[function(require,module,exports) {
"use strict";
...
},{"../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/WebGLRenderer.mjs":[function(require,module,exports) {
"use strict";
...
var _Utils = _interopRequireDefault(require("../../tree/Utils.mjs"));
var _StageUtils = _interopRequireDefault(require("../../tree/StageUtils.mjs"));
var _WebGLCoreQuadList = _interopRequireDefault(require("./WebGLCoreQuadList.mjs"));
var _WebGLCoreQuadOperation = _interopRequireDefault(require("./WebGLCoreQuadOperation.mjs"));
var _WebGLCoreRenderExecutor = _interopRequireDefault(require("./WebGLCoreRenderExecutor.mjs"));
var _CoreRenderState = _interopRequireDefault(require("../../tree/core/CoreRenderState.mjs"));
var _DefaultShader = _interopRequireDefault(require("./shaders/DefaultShader.mjs"));
var _WebGLShader = _interopRequireDefault(require("./WebGLShader.mjs"));
var _Renderer = _interopRequireDefault(require("../Renderer.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLRenderer extends _Renderer.default {
  constructor(stage) {
    super(stage);
  ...
  _createDefaultShader(ctx) {
    return new _DefaultShader.default(ctx);
  }
  _getShaderBaseType() {
    return _WebGLShader.default;
  }
  _getShaderAlternative(shaderType) {
    return shaderType.getWebGL && shaderType.getWebGL();
  }
  createCoreQuadList(ctx) {
    return new _WebGLCoreQuadList.default(ctx);
  }
  createCoreQuadOperation(ctx, shader, shaderOwner, renderTextureInfo, scissor, index) {
    return new _WebGLCoreQuadOperation.default(ctx, shader, shaderOwner, renderTextureInfo, scissor, index);
  }
  createCoreRenderExecutor(ctx) {
    return new _WebGLCoreRenderExecutor.default(ctx);
  }
  createCoreRenderState(ctx) {
    return new _CoreRenderState.default(ctx);
  }
  ...
  uploadTextureSource(textureSource, options) {
    ...
    glTexture.params = _Utils.default.cloneObjShallow(texParams);
    glTexture.options = _Utils.default.cloneObjShallow(texOptions);
    return glTexture;
  }
  ...
  addQuad(renderState, quads, index) {
    ...
    const mca = _StageUtils.default.mergeColorAlpha;
    if (r.tb !== 0 || r.tc !== 0) {
      floats[offset++] = r.px;
      floats[offset++] = r.py;
...
},{"../../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./WebGLCoreQuadList.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreQuadList.mjs","./WebGLCoreQuadOperation.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreQuadOperation.mjs","./WebGLCoreRenderExecutor.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLCoreRenderExecutor.mjs","../../tree/core/CoreRenderState.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreRenderState.mjs","./shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","./WebGLShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShader.mjs","../Renderer.mjs":"node_modules/@lightningjs/core/src/renderer/Renderer.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreQuadList.mjs":[function(require,module,exports) {
"use strict";
...
class C2dCoreQuadList extends _CoreQuadList.default {
  constructor(ctx) {
    super(ctx);
    this.renderContexts = [];
    this.modes = [];
...
exports.default = C2dCoreQuadList;
},{"../../tree/core/CoreQuadList.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreQuadList.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreQuadOperation.mjs":[function(require,module,exports) {
"use strict";
...
class C2dCoreQuadOperation extends _CoreQuadOperation.default {
  getRenderContext(index) {
...
exports.default = C2dCoreQuadOperation;
},{"../../tree/core/CoreQuadOperation.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreQuadOperation.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreRenderExecutor.mjs":[function(require,module,exports) {
"use strict";
...
class C2dCoreRenderExecutor extends _CoreRenderExecutor.default {
  init() {
  ...
  _clearRenderTexture() {
    ...
    if (!clearColor[0] && !clearColor[1] && !clearColor[2] && !clearColor[3]) {
      ...
      ctx.fillStyle = _StageUtils.default.getRgbaStringFromArray(clearColor);
  ...
  static _equalScissorAreas(canvas, area, current) {
    ...
    return _Utils.default.equalValues(area, current);
  }
}
exports.default = C2dCoreRenderExecutor;
},{"../../tree/core/CoreRenderExecutor.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreRenderExecutor.mjs","../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dShader.mjs":[function(require,module,exports) {
"use strict";
...
class C2dShader extends _Shader.default {
  beforeDraw(operation) {}
  draw(operation) {}
  afterDraw(operation) {}
}
exports.default = C2dShader;
},{"../../tree/Shader.mjs":"node_modules/@lightningjs/core/src/tree/Shader.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/shaders/DefaultShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _C2dShader = _interopRequireDefault(require("../C2dShader.mjs"));
var _StageUtils = _interopRequireDefault(require("../../../tree/StageUtils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
...
class DefaultShader extends _C2dShader.default {
  constructor(ctx) {
    super(ctx);
      ...
      if (rect) {
        ...
        if (colorize) {
          ...
          if (vc._colorUl !== vc._colorUr || vc._colorUr !== vc._colorBl || vc._colorBr !== vc._colorBl) {
            color = _StageUtils.default.mergeMultiColorsEqual([vc._colorUl, vc._colorUr, vc._colorBl, vc._colorBr]);
          }
    ...
    if (vc._colorUl === vc._colorUr) {
      if (vc._colorBl === vc._colorBr) {
        if (vc._colorUl === vc.colorBl) {
          ...
          if (transparency) {
            gradient.addColorStop(0, _StageUtils.default.getRgbaString(vc._colorUl));
            gradient.addColorStop(1, _StageUtils.default.getRgbaString(vc._colorBl));
          } else {
            gradient.addColorStop(0, _StageUtils.default.getRgbString(vc._colorUl));
            gradient.addColorStop(1, _StageUtils.default.getRgbString(vc._colorBl));
          }
        }
      } else {
      ...
      if (vc._colorUl === vc._colorBl && vc._colorUr === vc._colorBr) {
        ...
        if (transparency) {
          gradient.addColorStop(0, _StageUtils.default.getRgbaString(vc._colorUl));
          gradient.addColorStop(1, _StageUtils.default.getRgbaString(vc._colorBr));
        } else {
          gradient.addColorStop(0, _StageUtils.default.getRgbString(vc._colorUl));
          gradient.addColorStop(1, _StageUtils.default.getRgbString(vc._colorBr));
        }
      }
    }
    if (gradient) {
      ...
      ctx.fillStyle = transparency ? _StageUtils.default.getRgbaString(color) : _StageUtils.default.getRgbString(color);
    }
  }
  _beforeDrawEl(info) {}
  _afterDrawEl(info) {}
...
exports.default = DefaultShader;
},{"../C2dShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dShader.mjs","../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dTextureTintManager.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = C2dTextureTintManager;
class C2dTintCache {
...
},{}],"node_modules/@lightningjs/core/src/renderer/c2d/C2dRenderer.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _C2dCoreQuadList = _interopRequireDefault(require("./C2dCoreQuadList.mjs"));
var _C2dCoreQuadOperation = _interopRequireDefault(require("./C2dCoreQuadOperation.mjs"));
var _C2dCoreRenderExecutor = _interopRequireDefault(require("./C2dCoreRenderExecutor.mjs"));
var _CoreRenderState = _interopRequireDefault(require("../../tree/core/CoreRenderState.mjs"));
var _DefaultShader = _interopRequireDefault(require("./shaders/DefaultShader.mjs"));
var _C2dShader = _interopRequireDefault(require("./C2dShader.mjs"));
var _Renderer = _interopRequireDefault(require("../Renderer.mjs"));
var _C2dTextureTintManager = _interopRequireDefault(require("./C2dTextureTintManager.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class C2dRenderer extends _Renderer.default {
  constructor(stage) {
    super(stage);
    this.tintManager = new _C2dTextureTintManager.default(stage);
  ...
  _getShaderBaseType() {
    return _C2dShader.default;
  }
  _getShaderAlternative(shaderType) {
    return shaderType.getC2d && shaderType.getC2d();
  }
  createCoreQuadList(ctx) {
    return new _C2dCoreQuadList.default(ctx);
  }
  createCoreQuadOperation(ctx, shader, shaderOwner, renderTextureInfo, scissor, index) {
    return new _C2dCoreQuadOperation.default(ctx, shader, shaderOwner, renderTextureInfo, scissor, index);
  }
  createCoreRenderExecutor(ctx) {
    return new _C2dCoreRenderExecutor.default(ctx);
  }
  createCoreRenderState(ctx) {
    return new _CoreRenderState.default(ctx);
  }
...
exports.default = C2dRenderer;
},{"./C2dCoreQuadList.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreQuadList.mjs","./C2dCoreQuadOperation.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreQuadOperation.mjs","./C2dCoreRenderExecutor.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dCoreRenderExecutor.mjs","../../tree/core/CoreRenderState.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreRenderState.mjs","./shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/DefaultShader.mjs","./C2dShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dShader.mjs","../Renderer.mjs":"node_modules/@lightningjs/core/src/renderer/Renderer.mjs","./C2dTextureTintManager.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dTextureTintManager.mjs"}],"node_modules/@lightningjs/core/src/renderer/spark/shaders/SparkShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _WebGLShader = _interopRequireDefault(require("../../webgl/WebGLShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class SparkShader extends _WebGLShader.default {
  enableAttribs() {
    // Enables the attribs in the shader program.
    let gl = this.gl;
    gl.vertexAttribPointer(this._attrib("aVertexPosition"), 2, gl.FLOAT, false, 20, 0);
...
`;
},{"../../webgl/WebGLShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/spark/SparkRenderer.mjs":[function(require,module,exports) {
...
exports.default = void 0;
var _WebGLRenderer = _interopRequireDefault(require("../webgl/WebGLRenderer.mjs"));
var _SparkShader = _interopRequireDefault(require("./shaders/SparkShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class SparkRenderer extends _WebGLRenderer.default {
  constructor(stage) {
    super(stage);
  }
  _createDefaultShader(ctx) {
    return new _SparkShader.default(ctx);
  }
  createCoreRenderExecutor(ctx) {
    global.beginDrawing();
...
exports.default = SparkRenderer;
},{"../webgl/WebGLRenderer.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLRenderer.mjs","./shaders/SparkShader.mjs":"node_modules/@lightningjs/core/src/renderer/spark/shaders/SparkShader.mjs"}],"node_modules/@lightningjs/core/src/platforms/browser/ImageWorker.mjs":[function(require,module,exports) {
"use strict";
...
const createWorker = function () {
  ...
  ImageWorkerServer.prototype.finish = function (item, {
    imageBitmap,
    hasAlphaChannel
  }) {
    postMessage({
  ...
  ImageWorkerServer.prototype.error = function (item, {
    type,
    message
  }) {
    postMessage({
...
},{}],"node_modules/@lightningjs/core/src/platforms/browser/WebPlatform.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Utils = _interopRequireDefault(require("../../tree/Utils.mjs"));
var _ImageWorker = _interopRequireDefault(require("./ImageWorker.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebPlatform {
  init(stage) {
    ...
    if (this.stage.getOption("useImageWorker")) {
      if (!window.createImageBitmap || !window.Worker) {
        ...
        this._imageWorker = new _ImageWorker.default();
      }
    }
  }
  destroy() {
  ...
  loadSrcTexture({
    ...
    if (this._imageWorker) {
      ...
      if (!(src.substr(0, 5) == "data:") && !_Utils.default.isPS4) {
        // Base64.
...
},{"../../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./ImageWorker.mjs":"node_modules/@lightningjs/core/src/platforms/browser/ImageWorker.mjs"}],"node_modules/@lightningjs/core/src/platforms/PlatformLoader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _WebPlatform = _interopRequireDefault(require("./browser/WebPlatform.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class PlatformLoader {
  static load(options) {
    if (options.platform) {
      ...
      return _WebPlatform.default;
    }
  }
}
exports.default = PlatformLoader;
},{"./browser/WebPlatform.mjs":"node_modules/@lightningjs/core/src/platforms/browser/WebPlatform.mjs"}],"node_modules/@lightningjs/core/src/tools/WebGLStateManager.mjs":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = WebGLStateManager;
},{}],"node_modules/@lightningjs/core/src/tree/TextureManager.mjs":[function(require,module,exports) {
"use strict";
...
class TextureManager {
  ...
  getTextureSource(func, id) {
    ...
    if (!textureSource) {
      ...
      textureSource = new _TextureSource.default(this, func);
      if (id) {
...
},{"./TextureSource.mjs":"node_modules/@lightningjs/core/src/tree/TextureSource.mjs"}],"node_modules/@lightningjs/core/src/tree/TextureThrottler.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = TextureThrottler;
TextureThrottler.MAX_UPLOAD_TIME_PER_FRAME = 10;
},{}],"node_modules/@lightningjs/core/src/tree/core/CoreContext.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@lightningjs/core/src/animation/TransitionSettings.mjs":[function(require,module,exports) {
"use strict";
...
class TransitionSettings {
  constructor(stage) {
    ...
    this._timingFunctionImpl = _StageUtils.default.getTimingFunction(this._timingFunction);
    this.delay = 0;
    this.duration = 0.2;
    this.merger = null;
  }
  ...
  set timingFunction(v) {
    ...
    this._timingFunctionImpl = _StageUtils.default.getTimingFunction(v);
  }
...
},{"../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/animation/TransitionManager.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Base = _interopRequireDefault(require("../tree/Base.mjs"));
var _TransitionSettings = _interopRequireDefault(require("./TransitionSettings.mjs"));
var _Transition = _interopRequireDefault(require("./Transition.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class TransitionManager {
  constructor(stage) {
     ...
     */
    this.active = new Set();
    this.defaultTransitionSettings = new _TransitionSettings.default(this.stage);
  }
  progress() {
    if (this.active.size) {
  ...
  createSettings(settings) {
    const transitionSettings = new _TransitionSettings.default();
    _Base.default.patchObject(transitionSettings, settings);
...
},{"../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","./TransitionSettings.mjs":"node_modules/@lightningjs/core/src/animation/TransitionSettings.mjs","./Transition.mjs":"node_modules/@lightningjs/core/src/animation/Transition.mjs"}],"node_modules/@lightningjs/core/src/tools/MultiSpline.mjs":[function(require,module,exports) {
"use strict";
...
class MultiSpline {
  ...
  parse(rgba, def) {
    let i, n;
    if (!_Utils.default.isObjectLiteral(def)) {
      def = {
        0: def
      };
    }
    ...
    for (let key in def) {
      if (def.hasOwnProperty(key)) {
        let obj = def[key];
        if (!_Utils.default.isObjectLiteral(obj)) {
          obj = {
            v: obj
          };
        }
        ...
        if (key === "sm") {
          ...
          obj.p = p;
          obj.f = _Utils.default.isFunction(obj.v);
    ...
    for (i = 0; i < n - 1; i++) {
      ...
      if (!items[i].f) {
        ...
        if (_Utils.default.isNumber(items[i].v) && _Utils.default.isNumber(items[i].lv)) {
  ...
  static getSplineRgbaValueFunction(v1, v2, p1, p2, o1, i2, s1, s2) {
    ...
    let helpers = [MultiSpline.getSplineHelpers(cv1[0], cv2[0], o1, i2, s1[0], s2[0]), MultiSpline.getSplineHelpers(cv1[1], cv2[1], o1, i2, s1[1], s2[1]), MultiSpline.getSplineHelpers(cv1[2], cv2[2], o1, i2, s1[2], s2[2]), MultiSpline.getSplineHelpers(cv1[3], cv2[3], o1, i2, s1[3], s2[3])];
    if (!helpers[0]) {
      return function (p) {
        // Linear.
        if (p === 0) return v1;
...
exports.default = MultiSpline;
},{"../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/animation/AnimationActionSettings.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _MultiSpline = _interopRequireDefault(require("../tools/MultiSpline.mjs"));
var _Element = _interopRequireDefault(require("../tree/Element.mjs"));
var _StageUtils = _interopRequireDefault(require("../tree/StageUtils.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _Base = _interopRequireDefault(require("../tree/Base.mjs"));
...
class AnimationActionSettings {
  constructor(animationSettings) {
     ...
     * @private;
     */
    this._items = new _MultiSpline.default();
  ...
  apply(element, p, factor) {
    ...
    if (factor !== 1) {
      ...
      if (_Utils.default.isNumber(v) && _Utils.default.isNumber(sv)) {
        if (this.hasColorProperty()) {
          v = _StageUtils.default.mergeColors(v, sv, factor);
        } else {
          v = _StageUtils.default.mergeNumbers(v, sv, factor);
        }
      }
    }
  ...
  set properties(v) {
    ...
    v.forEach(prop => {
      ...
      this._propSetters.push(_Element.default.getSetter(prop));
    });
  }
  set property(v) {
    this._hasColorProperty = undefined;
  ...
  hasColorProperty() {
    if (this._hasColorProperty === undefined) {
      this._hasColorProperty = this._props.length ? _Element.default.isColorProperty(this._props[0]) : false;
    }
    return this._hasColorProperty;
  }
}
exports.default = AnimationActionSettings;
AnimationActionSettings.prototype.isAnimationActionSettings = true;
},{"../tools/MultiSpline.mjs":"node_modules/@lightningjs/core/src/tools/MultiSpline.mjs","../tree/Element.mjs":"node_modules/@lightningjs/core/src/tree/Element.mjs","../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/animation/AnimationSettings.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _StageUtils = _interopRequireDefault(require("../tree/StageUtils.mjs"));
var _AnimationActionSettings = _interopRequireDefault(require("./AnimationActionSettings.mjs"));
var _Base = _interopRequireDefault(require("../tree/Base.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
...
class AnimationSettings {
  constructor() {
    ...
    this._stopTimingFunctionImpl = _StageUtils.default.getTimingFunction(this._stopTimingFunction);
    this.stopDuration = 0;
    this.stopDelay = 0;
  }
  get actions() {
  ...
  set actions(v) {
    ...
    for (let i = 0, n = v.length; i < n; i++) {
      ...
      if (!e.isAnimationActionSettings) {
        const aas = new _AnimationActionSettings.default(this);
        aas.patch(e);
  ...
  set stopTimingFunction(v) {
    ...
    this._stopTimingFunctionImpl = _StageUtils.default.getTimingFunction(v);
  }
...
},{"../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./AnimationActionSettings.mjs":"node_modules/@lightningjs/core/src/animation/AnimationActionSettings.mjs","../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs"}],"node_modules/@lightningjs/core/src/animation/Animation.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _EventEmitter = _interopRequireDefault(require("../EventEmitter.mjs"));
var _AnimationSettings = _interopRequireDefault(require("./AnimationSettings.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Animation extends _EventEmitter.default {
  ...
  play() {
    if (this._state === Animation.STATES.PAUSED) {
      ...
      this.checkActive();
      this.emit('resume');
    } else if (this._state == Animation.STATES.STOPPING && this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.REVERSE) {
      // Continue.;
      this._state = Animation.STATES.PLAYING;
  ...
  stop() {
    ...
    if (this.settings.stopMethod === _AnimationSettings.default.STOP_METHODS.IMMEDIATE && !this._stopDelayLeft || this._delayLeft > 0) {
      // Stop upon next progress.;
      this._state = Animation.STATES.STOPPING;
      this.emit('stop');
    } else {
      if (this.settings.stopMethod === _AnimationSettings.default.STOP_METHODS.FADE) {
        this._stopP = 0;
      }
      this._state = Animation.STATES.STOPPING;
      this.emit('stop');
  ...
  _stopProgress(dt) {
    ...
    if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.IMMEDIATE) {
      this._state = Animation.STATES.STOPPED;
      this.emit('stopFinish');
    } else if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.REVERSE) {
      if (duration === 0) {
        this._p = 0;
      } else if (duration > 0) {
        this._p -= dt / duration;
    ...
    } else if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.FADE) {
    ...
    } else if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.ONETOTWO) {
      if (this._p < 2) {
        if (duration === 0) {
          this._p = 2;
        } else if (duration > 0) {
    ...
    } else if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.FORWARD) {
      if (this._p < 1) {
        if (this.settings.duration == 0) {
          this._p = 1;
        } else {
        ...
        if (this._p >= 1) {
          if (this.settings.stopMethod == _AnimationSettings.default.STOP_METHODS.FORWARD) {
            this._p = 1;
            this._state = Animation.STATES.STOPPED;
            this.emit('stopFinish');
          } else {
  ...
  apply() {
    if (this._state === Animation.STATES.STOPPED) {
      ...
      let factor = 1;
      if (this._state === Animation.STATES.STOPPING && this.settings.stopMethod === _AnimationSettings.default.STOP_METHODS.FADE) {
...
},{"../EventEmitter.mjs":"node_modules/@lightningjs/core/src/EventEmitter.mjs","./AnimationSettings.mjs":"node_modules/@lightningjs/core/src/animation/AnimationSettings.mjs"}],"node_modules/@lightningjs/core/src/animation/AnimationManager.mjs":[function(require,module,exports) {
"use strict";
...
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _AnimationSettings = _interopRequireDefault(require("./AnimationSettings.mjs"));
var _Animation = _interopRequireDefault(require("./Animation.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class AnimationManager {
  ...
  createAnimation(element, settings) {
    ...
    return new _Animation.default(this, settings, element);
  }
  createSettings(settings) {
    const animationSettings = new _AnimationSettings.default();
    _Base.default.patchObject(animationSettings, settings);
...
},{"../tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./AnimationSettings.mjs":"node_modules/@lightningjs/core/src/animation/AnimationSettings.mjs","./Animation.mjs":"node_modules/@lightningjs/core/src/animation/Animation.mjs"}],"node_modules/@lightningjs/core/src/textures/RectangleTexture.mjs":[function(require,module,exports) {
"use strict";
...
class RectangleTexture extends _Texture.default {
  _getLookupId() {
    return '__whitepix';
  }
  _getSourceLoader() {
...
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/tree/Stage.mjs":[function(require,module,exports) {
"use strict";
...
var _EventEmitter = _interopRequireDefault(require("../EventEmitter.mjs"));
var _Utils = _interopRequireDefault(require("./Utils.mjs"));
var _WebGLRenderer = _interopRequireDefault(require("../renderer/webgl/WebGLRenderer.mjs"));
var _C2dRenderer = _interopRequireDefault(require("../renderer/c2d/C2dRenderer.mjs"));
var _SparkRenderer = _interopRequireDefault(require("../renderer/spark/SparkRenderer.mjs"));
var _PlatformLoader = _interopRequireDefault(require("../platforms/PlatformLoader.mjs"));
var _WebGLStateManager = _interopRequireDefault(require("../tools/WebGLStateManager.mjs"));
var _Shader = _interopRequireDefault(require("./Shader.mjs"));
var _Element = _interopRequireDefault(require("./Element.mjs"));
var _StageUtils = _interopRequireDefault(require("./StageUtils.mjs"));
var _TextureManager = _interopRequireDefault(require("./TextureManager.mjs"));
var _TextureThrottler = _interopRequireDefault(require("./TextureThrottler.mjs"));
var _CoreContext = _interopRequireDefault(require("./core/CoreContext.mjs"));
var _TransitionManager = _interopRequireDefault(require("../animation/TransitionManager.mjs"));
var _AnimationManager = _interopRequireDefault(require("../animation/AnimationManager.mjs"));
var _RectangleTexture = _interopRequireDefault(require("../textures/RectangleTexture.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Stage extends _EventEmitter.default {
  constructor(options = {}) {
    super();
    this._setOptions(options);
    this._usedMemory = 0;
    this._lastGcFrame = 0;
    const platformType = Stage.platform ? Stage.platform : _PlatformLoader.default.load(options);
    ...
    if (context) {
      ...
      if (_Utils.default.isWeb && (!Stage.isWebglSupported() || this.getOption('canvas2d'))) {
    ...
    if (this.gl) {
      ...
      _WebGLStateManager.default.enable(this.gl, "lightning");
    }
    ...
    if (this._mode === 0) {
      if (_Utils.default.isSpark) {
        this._renderer = new _SparkRenderer.default(this);
      } else {
        this._renderer = new _WebGLRenderer.default(this);
      }
    } else {
      this._renderer = new _C2dRenderer.default(this);
    }
    this.setClearColor(this.getOption('clearColor'));
    this.frameCounter = 0;
    this.transitions = new _TransitionManager.default(this);
    this.animations = new _AnimationManager.default(this);
    this.textureManager = new _TextureManager.default(this);
    this.textureThrottler = new _TextureThrottler.default(this);
    this.startTime = 0;
    this.currentTime = 0;
    this.dt = 0;

    // Preload rectangle texture, so that we can skip some border checks for loading textures.
    this.rectangleTexture = new _RectangleTexture.default(this);
    this.rectangleTexture.load();

    // Never clean up because we use it all the time.
    this.rectangleTexture.source.permanent = true;
    this.ctx = new _CoreContext.default(this);
  ...
  setClearColor(clearColor) {
    ...
    if (clearColor === null) {
      ...
      this._clearColor = _StageUtils.default.getRgbaComponentsNormalized(clearColor);
    }
  }
  getClearColor() {
  ...
  createElement(settings) {
    if (settings) {
      ...
      return new _Element.default(this);
    }
  }
  createShader(settings) {
    return _Shader.default.create(this, settings);
  }
  element(settings) {
    ...
    if (settings.type) {
      ...
      element = new _Element.default(this);
    }
...
},{"../EventEmitter.mjs":"node_modules/@lightningjs/core/src/EventEmitter.mjs","./Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../renderer/webgl/WebGLRenderer.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLRenderer.mjs","../renderer/c2d/C2dRenderer.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dRenderer.mjs","../renderer/spark/SparkRenderer.mjs":"node_modules/@lightningjs/core/src/renderer/spark/SparkRenderer.mjs","../platforms/PlatformLoader.mjs":"node_modules/@lightningjs/core/src/platforms/PlatformLoader.mjs","../tools/WebGLStateManager.mjs":"node_modules/@lightningjs/core/src/tools/WebGLStateManager.mjs","./Shader.mjs":"node_modules/@lightningjs/core/src/tree/Shader.mjs","./Element.mjs":"node_modules/@lightningjs/core/src/tree/Element.mjs","./StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./TextureManager.mjs":"node_modules/@lightningjs/core/src/tree/TextureManager.mjs","./TextureThrottler.mjs":"node_modules/@lightningjs/core/src/tree/TextureThrottler.mjs","./core/CoreContext.mjs":"node_modules/@lightningjs/core/src/tree/core/CoreContext.mjs","../animation/TransitionManager.mjs":"node_modules/@lightningjs/core/src/animation/TransitionManager.mjs","../animation/AnimationManager.mjs":"node_modules/@lightningjs/core/src/animation/AnimationManager.mjs","../textures/RectangleTexture.mjs":"node_modules/@lightningjs/core/src/textures/RectangleTexture.mjs"}],"node_modules/@lightningjs/core/src/application/Application.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Component = _interopRequireDefault(require("./Component.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _Stage = _interopRequireDefault(require("../tree/Stage.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Application extends _Component.default {
  constructor(options = {}, properties) {
    ...
    const stage = new _Stage.default(options.stage);
  ...
  updateFocusSettings() {
    ...
    const focusSettings = {};
    const defaultSetFocusSettings = _Component.default.prototype._setFocusSettings;
    for (let i = 0, n = this._focusPath.length; i < n; i++) {
      if (this._focusPath[i]._setFocusSettings !== defaultSetFocusSettings) {
        this._focusPath[i]._setFocusSettings(focusSettings);
      }
    }
    const defaultHandleFocusSettings = _Component.default.prototype._handleFocusSettings;
    for (let i = 0, n = this._focusPath.length; i < n; i++) {
  ...
  _startLongpressTimer(key, element) {
    ...
    if (config[lookup]) {
      ...
      if (!_Utils.default.isNumber(timeout)) {
    ...
    if (target !== this.__hoveredChild) {
      ...
      if (this.__hoveredChild) {
        ...
        for (const elem of [...hoveredBranch].filter(e => !newHoveredBranch.has(e))) {
          const c = _Component.default.getComponent(elem);
          if (c["_handleUnhover"]) {
      ...
      if (diffBranch.length === 0 && target) {
        const c = _Component.default.getComponent(target);
        if (c["_handleHover"]) {
  ...
  _withinClickableRange(affectedChildren, cursorX, cursorY) {
    ...
    while (n--) {
      ...
      if (child.parent.core._scissor) {
        ...
        if (!this._testCollision(cursorX, cursorY, ...scissor)) continue;
      }
...
},{"./Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../tree/Stage.mjs":"node_modules/@lightningjs/core/src/tree/Stage.mjs"}],"node_modules/@lightningjs/core/src/textures/StaticCanvasTexture.mjs":[function(require,module,exports) {
"use strict";
...
class StaticCanvasTexture extends _Texture.default {
  constructor(stage) {
    super(stage);
...
exports.default = StaticCanvasTexture;
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/tools/Tools.mjs":[function(require,module,exports) {
"use strict";
...
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
var _StageUtils = _interopRequireDefault(require("../tree/StageUtils.mjs"));
var _StaticCanvasTexture = _interopRequireDefault(require("../textures/StaticCanvasTexture.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class Tools {
  static getCanvasTexture(canvasFactory, lookupId) {
    return {
      type: _StaticCanvasTexture.default,
      content: {
  ...
  static createRoundRect(stage, w, h, radius, strokeWidth, strokeColor, fill, fillColor) {
    ...
    ctx.closePath();
    if (fill) {
      if (_Utils.default.isNumber(fillColor)) {
        ctx.fillStyle = _StageUtils.default.getRgbaString(fillColor);
      } else {
        ctx.fillStyle = "white";
      }
      ctx.fill();
    ...
    if (strokeWidth) {
      if (_Utils.default.isNumber(strokeColor)) {
        ctx.strokeStyle = _StageUtils.default.getRgbaString(strokeColor);
      } else {
  ...
  static createShadowRect(stage, w, h, radius, blur, margin) {
    ...
    ctx.globalAlpha = 1.0;
    ctx.shadowColor = _StageUtils.default.getRgbaString(0xFFFFFFFF);
    ctx.fillStyle = _StageUtils.default.getRgbaString(0xFFFFFFFF);
    ctx.shadowBlur = blur;
...
},{"../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","../textures/StaticCanvasTexture.mjs":"node_modules/@lightningjs/core/src/textures/StaticCanvasTexture.mjs"}],"node_modules/@lightningjs/core/src/tools/ObjMerger.mjs":[function(require,module,exports) {
"use strict";
...
class ObjMerger {
  static isMf(f) {
    return _Utils.default.isFunction(f) && f.__mf;
  }
  static mf(f) {
  ...
  static merge(a, b) {
    ...
    for (let i = 0, n = bks.length; i < n; i++) {
      ...
      if (this.isMf(bv)) {
        ...
        if (!_Utils.default.isObjectLiteral(av) || !_Utils.default.isObjectLiteral(bv)) {
          r = bv;
        } else {
...
exports.default = ObjMerger;
},{"../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/tools/ObjectListProxy.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _ObjectList = _interopRequireDefault(require("../tree/ObjectList.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ObjectListProxy extends _ObjectList.default {
  constructor(target) {
    super();
    this._target = target;
  }
...
exports.default = ObjectListProxy;
},{"../tree/ObjectList.mjs":"node_modules/@lightningjs/core/src/tree/ObjectList.mjs"}],"node_modules/@lightningjs/core/src/tools/ObjectListWrapper.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _ObjectListProxy = _interopRequireDefault(require("./ObjectListProxy.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class ObjectListWrapper extends _ObjectListProxy.default {
...
exports.default = ObjectListWrapper;
},{"./ObjectListProxy.mjs":"node_modules/@lightningjs/core/src/tools/ObjectListProxy.mjs"}],"node_modules/@lightningjs/core/src/textures/NoiseTexture.mjs":[function(require,module,exports) {
"use strict";
...
class NoiseTexture extends _Texture.default {
  _getLookupId() {
    return '__noise';
  }
  _getSourceLoader() {
...
exports.default = NoiseTexture;
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/textures/HtmlTexture.mjs":[function(require,module,exports) {
"use strict";
...
class HtmlTexture extends _Texture.default {
  constructor(stage) {
    super(stage);
...
exports.default = HtmlTexture;
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/textures/StaticTexture.mjs":[function(require,module,exports) {
"use strict";
...
class StaticTexture extends _Texture.default {
...
exports.default = StaticTexture;
},{"../tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs"}],"node_modules/@lightningjs/core/src/components/ListComponent.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Component = _interopRequireDefault(require("../application/Component.mjs"));
var _ObjectListWrapper = _interopRequireDefault(require("../tools/ObjectListWrapper.mjs"));
var _Utils = _interopRequireDefault(require("../tree/Utils.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
...
class ListComponent extends _Component.default {
  constructor(stage) {
    super(stage);
  ...
  setIndex(index, immediate = false, closest = false) {
    ...
    if (closest) {
      ...
      let offset = _Utils.default.getModuloIndex(index, nElements);
      let o = _Utils.default.getModuloIndex(this.index, nElements);
      let diff = offset - o;
    ...
    if (this._roll || this.viewportSize > this._itemSize * nElements) {
      this._index = _Utils.default.getModuloIndex(this._index, nElements);
    }
  ...
  update() {
    ...
    for (let index = s; direction == -1 ? index <= e : index >= e; direction == -1 ? index++ : index--) {
      let realIndex = _Utils.default.getModuloIndex(index, nElements);
  ...
  get realIndex() {
    return _Utils.default.getModuloIndex(this._index, this.length);
  }
  get itemSize() {
...
class ListItems extends _ObjectListWrapper.default {
  constructor(list) {
    let wrap = item => {
...
},{"../application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs","../tools/ObjectListWrapper.mjs":"node_modules/@lightningjs/core/src/tools/ObjectListWrapper.mjs","../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/LinearBlurShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _DefaultShader = _interopRequireDefault(require("./DefaultShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class LinearBlurShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
...
exports.default = LinearBlurShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/BoxBlurShader.mjs":[function(require,module,exports) {
"use strict";
 ...
 */
class BoxBlurShader extends _DefaultShader.default {
  setupUniforms(operation) {
    super.setupUniforms(operation);
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/c2d/shaders/BlurShader.mjs":[function(require,module,exports) {
"use strict";
...
class BlurShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._kernelRadius = 1;
  }
...
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/components/FastBlurComponent.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Component = _interopRequireDefault(require("../application/Component.mjs"));
var _LinearBlurShader = _interopRequireDefault(require("../renderer/webgl/shaders/LinearBlurShader.mjs"));
var _BoxBlurShader = _interopRequireDefault(require("../renderer/webgl/shaders/BoxBlurShader.mjs"));
var _DefaultShader = _interopRequireDefault(require("../renderer/webgl/shaders/DefaultShader.mjs"));
var _BlurShader = _interopRequireDefault(require("../renderer/c2d/shaders/BlurShader.mjs"));
var _Shader = _interopRequireDefault(require("../tree/Shader.mjs"));
var _MultiSpline = _interopRequireDefault(require("../tools/MultiSpline.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
...
class FastBlurComponent extends _Component.default {
  static _template() {
    return {};
  }
  get wrap() {
...
exports.default = FastBlurComponent;
class C2dFastBlurComponent extends _Component.default {
  static _template() {
    return {
  ...
  static getSpline() {
    if (!this._multiSpline) {
      this._multiSpline = new _MultiSpline.default();
...
class WebGLFastBlurComponent extends _Component.default {
  static _template() {
  ...
  _buildLayers() {
    ...
    const filterShaders = filterShaderSettings.map(s => {
      const shader = _Shader.default.create(this.stage, Object.assign({
        type: _LinearBlurShader.default
      }, s));
      return shader;
    });
 ...
 */
class FastBlurOutputShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._a = 0;
...
`;
},{"../application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs","../renderer/webgl/shaders/LinearBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/LinearBlurShader.mjs","../renderer/webgl/shaders/BoxBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/BoxBlurShader.mjs","../renderer/webgl/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","../renderer/c2d/shaders/BlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/BlurShader.mjs","../tree/Shader.mjs":"node_modules/@lightningjs/core/src/tree/Shader.mjs","../tools/MultiSpline.mjs":"node_modules/@lightningjs/core/src/tools/MultiSpline.mjs"}],"node_modules/@lightningjs/core/src/components/BloomComponent.mjs":[function(require,module,exports) {
"use strict";
...
class BloomComponent extends _Component.default {
  static _template() {
    const onUpdate = function (element, elementCore) {
      if (elementCore._recalc & 2 + 128) {
        const w = elementCore.w;
  ...
  _build() {
    ...
    const filterShaders = filterShaderSettings.map(s => {
      const shader = this.stage.createShader(Object.assign({
        type: _LinearBlurShader.default
      }, s));
      return shader;
    });
...
exports.default = BloomComponent;
class BloomBaseShader extends _DefaultShader.default {}
...
`;
},{"../application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs","../renderer/webgl/shaders/LinearBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/LinearBlurShader.mjs","../renderer/webgl/shaders/BoxBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/BoxBlurShader.mjs","../renderer/webgl/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/components/SmoothScaleComponent.mjs":[function(require,module,exports) {
"use strict";
...
class SmoothScaleComponent extends _Component.default {
  static _template() {
    return {
      ContentWrap: {
        renderOffscreen: true,
...
exports.default = SmoothScaleComponent;
},{"../application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs"}],"node_modules/@lightningjs/core/src/components/BorderComponent.mjs":[function(require,module,exports) {
"use strict";
...
class BorderComponent extends _Component.default {
  static _template() {
    return {
      Content: {},
      Borders: {
...
},{"../application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs"}],"node_modules/@lightningjs/core/src/renderer/common/shaders/GrayscaleShader.mjs":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.WebGLGrayscaleShader = exports.C2dGrayscaleShader = void 0;
var _DefaultShader = _interopRequireDefault(require("../../c2d/shaders/DefaultShader.mjs"));
var _DefaultShader2 = _interopRequireDefault(require("../../webgl/shaders/DefaultShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
class WebGLGrayscaleShader extends _DefaultShader2.default {
  constructor(context) {
    super(context);
    this._amount = 1;
  }
...
`;
class C2dGrayscaleShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._amount = 1;
  }
...
},{"../../c2d/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/DefaultShader.mjs","../../webgl/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DitheringShader.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _NoiseTexture = _interopRequireDefault(require("../../../textures/NoiseTexture.mjs"));
var _DefaultShader = _interopRequireDefault(require("./DefaultShader.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 ...
 */
class DitheringShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._noiseTexture = new _NoiseTexture.default(ctx.stage);
...
exports.default = DitheringShader;
...
`;
},{"../../../textures/NoiseTexture.mjs":"node_modules/@lightningjs/core/src/textures/NoiseTexture.mjs","./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/CircularPushShader.mjs":[function(require,module,exports) {
"use strict";
...
class CircularPushShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._inputValue = 0;
...
exports.default = CircularPushShader;
...
`;
},{"../../../tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/InversionShader.mjs":[function(require,module,exports) {
"use strict";
...
class InversionShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._amount = 1;
  }
...
exports.default = InversionShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/OutlineShader.mjs":[function(require,module,exports) {
"use strict";
...
class OutlineShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._width = 5;
  ...
  set color(v) {
    if (this._col !== v) {
      const col = _StageUtils.default.getRgbaComponentsNormalized(v);
      col[0] = col[0] * col[3];
      col[1] = col[1] * col[3];
      col[2] = col[2] * col[3];
      this._color = col;
...
`;
},{"../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/PixelateShader.mjs":[function(require,module,exports) {
"use strict";
 ...
 */
class PixelateShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
...
exports.default = PixelateShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RadialFilterShader.mjs":[function(require,module,exports) {
"use strict";
...
class RadialFilterShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._radius = 0;
    this._cutoff = 1;
...
exports.default = RadialFilterShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RoundedRectangleShader.mjs":[function(require,module,exports) {
"use strict";
...
class RoundedRectangleShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._blend = 0;
  ...
  _getNormalizedColor(color) {
    const col = _StageUtils.default.getRgbaComponentsNormalized(color);
    col[0] *= col[3];
    col[1] *= col[3];
    col[2] *= col[3];
...
exports.default = RoundedRectangleShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/FadeOutShader.mjs":[function(require,module,exports) {
"use strict";
...
class FadeOutShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._fade = [0, 0, 0, 0];
  }
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/VignetteShader.mjs":[function(require,module,exports) {
"use strict";
...
class VignetteShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._magnitude = 1.3;
    this._intensity = 0.7;
...
VignetteShader.vertexShaderSource = _DefaultShader.default.vertexShaderSource;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/SpinnerShader.mjs":[function(require,module,exports) {
"use strict";
...
class SpinnerShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._radius = 100;
    this._width = 50;
  ...
  setupUniforms(operation) {
    ...
    this._setUniform('color', new Float32Array(_StageUtils.default.getRgbaComponentsNormalized(this._color)), this.gl.uniform4fv);
    this._setUniform('backgroundColor', new Float32Array(_StageUtils.default.getRgbaComponentsNormalized(this._backgroundColor)), this.gl.uniform4fv);
    this._setUniform('resolution', new Float32Array([owner._w * renderPrecision, owner._h * renderPrecision]), this.gl.uniform2fv);
    this.redraw();
  }
}
exports.default = SpinnerShader;
SpinnerShader.vertexShaderSource = _DefaultShader.default.vertexShaderSource;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/HoleShader.mjs":[function(require,module,exports) {
"use strict";
...
class HoleShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._x = 0;
    this._y = 0;
...
exports.default = HoleShader;
HoleShader.vertexShaderSource = _DefaultShader.default.vertexShaderSource;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RadialGradientShader.mjs":[function(require,module,exports) {
"use strict";
...
class RadialGradientShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._pivot = [0, 0];
    this._ic = 0xffffffff;
  ...
  setupUniforms(operation) {
    ...
    this._setUniform('fill', _StageUtils.default.getRgbaComponentsNormalized(this._oc)[3], this.gl.uniform1f);
...
exports.default = RadialGradientShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/Light3dShader.mjs":[function(require,module,exports) {
"use strict";
...
class Light3dShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._strength = 0.5;
    this._ambient = 0.5;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/PerspectiveShader.mjs":[function(require,module,exports) {
"use strict";
...
class PerspectiveShader extends _DefaultShader.default {
  constructor(ctx) {
    super(ctx);
    this._fudge = 0.2;
    this._rx = 0;
...
exports.default = PerspectiveShader;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/MagnifierShader.mjs":[function(require,module,exports) {
"use strict";
...
class MagnifierShader extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._x = 0;
    this._y = 0;
...
exports.default = MagnifierShader;
MagnifierShader.vertexShaderSource = _DefaultShader.default.vertexShaderSource;
MagnifierShader.fragmentShaderSource = `
  ...
  `;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs"}],"node_modules/@lightningjs/core/src/renderer/webgl/shaders/SpinnerShader2.mjs":[function(require,module,exports) {
"use strict";
...
class SpinnerShader2 extends _DefaultShader.default {
  constructor(context) {
    super(context);
    this._period = 1;
    this._stroke = 0;
...
exports.default = SpinnerShader2;
...
`;
},{"./DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","../../../tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs"}],"node_modules/@lightningjs/core/src/lightning.mjs":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _Application = _interopRequireDefault(require("./application/Application.mjs"));
var _Component = _interopRequireDefault(require("./application/Component.mjs"));
var _Base = _interopRequireDefault(require("./tree/Base.mjs"));
var _Utils = _interopRequireDefault(require("./tree/Utils.mjs"));
var _StageUtils = _interopRequireDefault(require("./tree/StageUtils.mjs"));
var _Element = _interopRequireDefault(require("./tree/Element.mjs"));
var _ElementCore = _interopRequireDefault(require("./tree/core/ElementCore.mjs"));
var _ElementTexturizer = _interopRequireDefault(require("./tree/core/ElementTexturizer.mjs"));
var _Texture = _interopRequireDefault(require("./tree/Texture.mjs"));
var _Tools = _interopRequireDefault(require("./tools/Tools.mjs"));
var _ObjMerger = _interopRequireDefault(require("./tools/ObjMerger.mjs"));
var _ObjectListProxy = _interopRequireDefault(require("./tools/ObjectListProxy.mjs"));
var _ObjectListWrapper = _interopRequireDefault(require("./tools/ObjectListWrapper.mjs"));
var _RectangleTexture = _interopRequireDefault(require("./textures/RectangleTexture.mjs"));
var _NoiseTexture = _interopRequireDefault(require("./textures/NoiseTexture.mjs"));
var _TextTexture = _interopRequireDefault(require("./textures/TextTexture.mjs"));
var _ImageTexture = _interopRequireDefault(require("./textures/ImageTexture.mjs"));
var _HtmlTexture = _interopRequireDefault(require("./textures/HtmlTexture.mjs"));
var _StaticTexture = _interopRequireDefault(require("./textures/StaticTexture.mjs"));
var _StaticCanvasTexture = _interopRequireDefault(require("./textures/StaticCanvasTexture.mjs"));
var _SourceTexture = _interopRequireDefault(require("./textures/SourceTexture.mjs"));
var _ListComponent = _interopRequireDefault(require("./components/ListComponent.mjs"));
var _FastBlurComponent = _interopRequireDefault(require("./components/FastBlurComponent.mjs"));
var _BloomComponent = _interopRequireDefault(require("./components/BloomComponent.mjs"));
var _SmoothScaleComponent = _interopRequireDefault(require("./components/SmoothScaleComponent.mjs"));
var _BorderComponent = _interopRequireDefault(require("./components/BorderComponent.mjs"));
var _EventEmitter = _interopRequireDefault(require("./EventEmitter.mjs"));
var _WebGLShader = _interopRequireDefault(require("./renderer/webgl/WebGLShader.mjs"));
var _DefaultShader = _interopRequireDefault(require("./renderer/webgl/shaders/DefaultShader.mjs"));
var _GrayscaleShader = require("./renderer/common/shaders/GrayscaleShader.mjs");
var _BoxBlurShader = _interopRequireDefault(require("./renderer/webgl/shaders/BoxBlurShader.mjs"));
var _DitheringShader = _interopRequireDefault(require("./renderer/webgl/shaders/DitheringShader.mjs"));
var _CircularPushShader = _interopRequireDefault(require("./renderer/webgl/shaders/CircularPushShader.mjs"));
var _InversionShader = _interopRequireDefault(require("./renderer/webgl/shaders/InversionShader.mjs"));
var _LinearBlurShader = _interopRequireDefault(require("./renderer/webgl/shaders/LinearBlurShader.mjs"));
var _OutlineShader = _interopRequireDefault(require("./renderer/webgl/shaders/OutlineShader.mjs"));
var _PixelateShader = _interopRequireDefault(require("./renderer/webgl/shaders/PixelateShader.mjs"));
var _RadialFilterShader = _interopRequireDefault(require("./renderer/webgl/shaders/RadialFilterShader.mjs"));
var _RoundedRectangleShader = _interopRequireDefault(require("./renderer/webgl/shaders/RoundedRectangleShader.mjs"));
var _FadeOutShader = _interopRequireDefault(require("./renderer/webgl/shaders/FadeOutShader.mjs"));
var _VignetteShader = _interopRequireDefault(require("./renderer/webgl/shaders/VignetteShader.mjs"));
var _SpinnerShader = _interopRequireDefault(require("./renderer/webgl/shaders/SpinnerShader.mjs"));
var _HoleShader = _interopRequireDefault(require("./renderer/webgl/shaders/HoleShader.mjs"));
var _RadialGradientShader = _interopRequireDefault(require("./renderer/webgl/shaders/RadialGradientShader.mjs"));
var _Light3dShader = _interopRequireDefault(require("./renderer/webgl/shaders/Light3dShader.mjs"));
var _PerspectiveShader = _interopRequireDefault(require("./renderer/webgl/shaders/PerspectiveShader.mjs"));
var _MagnifierShader = _interopRequireDefault(require("./renderer/webgl/shaders/MagnifierShader.mjs"));
var _C2dShader = _interopRequireDefault(require("./renderer/c2d/C2dShader.mjs"));
var _DefaultShader2 = _interopRequireDefault(require("./renderer/c2d/shaders/DefaultShader.mjs"));
var _BlurShader = _interopRequireDefault(require("./renderer/c2d/shaders/BlurShader.mjs"));
var _Stage = _interopRequireDefault(require("./tree/Stage.mjs"));
var _SpinnerShader2 = _interopRequireDefault(require("./renderer/webgl/shaders/SpinnerShader2.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
...
const lightning = {
  ...
  StageUtils: _StageUtils.default,
  Element: _Element.default,
  Tools: _Tools.default,
  Stage: _Stage.default,
  ElementCore: _ElementCore.default,
  ElementTexturizer: _ElementTexturizer.default,
  Texture: _Texture.default,
  EventEmitter: _EventEmitter.default,
  shaders: {
    Grayscale: _GrayscaleShader.WebGLGrayscaleShader,
    BoxBlur: _BoxBlurShader.default,
    Dithering: _DitheringShader.default,
    CircularPush: _CircularPushShader.default,
    Inversion: _InversionShader.default,
    LinearBlur: _LinearBlurShader.default,
    Outline: _OutlineShader.default,
    Pixelate: _PixelateShader.default,
    RadialFilter: _RadialFilterShader.default,
    RoundedRectangle: _RoundedRectangleShader.default,
    Spinner2: _SpinnerShader2.default,
    FadeOut: _FadeOutShader.default,
    Hole: _HoleShader.default,
    Vignette: _VignetteShader.default,
    Spinner: _SpinnerShader.default,
    RadialGradient: _RadialGradientShader.default,
    Light3d: _Light3dShader.default,
    Perspective: _PerspectiveShader.default,
    Magnifier: _MagnifierShader.default,
    WebGLShader: _WebGLShader.default,
    WebGLDefaultShader: _DefaultShader.default,
    C2dShader: _C2dShader.default,
    C2dDefaultShader: _DefaultShader2.default,
    c2d: {
      Grayscale: _GrayscaleShader.C2dGrayscaleShader,
      Blur: _BlurShader.default
    }
  },
  textures: {
    RectangleTexture: _RectangleTexture.default,
    NoiseTexture: _NoiseTexture.default,
    TextTexture: _TextTexture.default,
    ImageTexture: _ImageTexture.default,
    HtmlTexture: _HtmlTexture.default,
    StaticTexture: _StaticTexture.default,
    StaticCanvasTexture: _StaticCanvasTexture.default,
    SourceTexture: _SourceTexture.default
  },
  components: {
    FastBlurComponent: _FastBlurComponent.default,
    BloomComponent: _BloomComponent.default,
    SmoothScaleComponent: _SmoothScaleComponent.default,
    BorderComponent: _BorderComponent.default,
    ListComponent: _ListComponent.default
  },
  tools: {
    ObjMerger: _ObjMerger.default,
    ObjectListProxy: _ObjectListProxy.default,
    ObjectListWrapper: _ObjectListWrapper.default
  }
};
if (_Utils.default.isWeb) {
  window.lng = lightning;
}
var _default = exports.default = lightning;
},{"./application/Application.mjs":"node_modules/@lightningjs/core/src/application/Application.mjs","./application/Component.mjs":"node_modules/@lightningjs/core/src/application/Component.mjs","./tree/Base.mjs":"node_modules/@lightningjs/core/src/tree/Base.mjs","./tree/Utils.mjs":"node_modules/@lightningjs/core/src/tree/Utils.mjs","./tree/StageUtils.mjs":"node_modules/@lightningjs/core/src/tree/StageUtils.mjs","./tree/Element.mjs":"node_modules/@lightningjs/core/src/tree/Element.mjs","./tree/core/ElementCore.mjs":"node_modules/@lightningjs/core/src/tree/core/ElementCore.mjs","./tree/core/ElementTexturizer.mjs":"node_modules/@lightningjs/core/src/tree/core/ElementTexturizer.mjs","./tree/Texture.mjs":"node_modules/@lightningjs/core/src/tree/Texture.mjs","./tools/Tools.mjs":"node_modules/@lightningjs/core/src/tools/Tools.mjs","./tools/ObjMerger.mjs":"node_modules/@lightningjs/core/src/tools/ObjMerger.mjs","./tools/ObjectListProxy.mjs":"node_modules/@lightningjs/core/src/tools/ObjectListProxy.mjs","./tools/ObjectListWrapper.mjs":"node_modules/@lightningjs/core/src/tools/ObjectListWrapper.mjs","./textures/RectangleTexture.mjs":"node_modules/@lightningjs/core/src/textures/RectangleTexture.mjs","./textures/NoiseTexture.mjs":"node_modules/@lightningjs/core/src/textures/NoiseTexture.mjs","./textures/TextTexture.mjs":"node_modules/@lightningjs/core/src/textures/TextTexture.mjs","./textures/ImageTexture.mjs":"node_modules/@lightningjs/core/src/textures/ImageTexture.mjs","./textures/HtmlTexture.mjs":"node_modules/@lightningjs/core/src/textures/HtmlTexture.mjs","./textures/StaticTexture.mjs":"node_modules/@lightningjs/core/src/textures/StaticTexture.mjs","./textures/StaticCanvasTexture.mjs":"node_modules/@lightningjs/core/src/textures/StaticCanvasTexture.mjs","./textures/SourceTexture.mjs":"node_modules/@lightningjs/core/src/textures/SourceTexture.mjs","./components/ListComponent.mjs":"node_modules/@lightningjs/core/src/components/ListComponent.mjs","./components/FastBlurComponent.mjs":"node_modules/@lightningjs/core/src/components/FastBlurComponent.mjs","./components/BloomComponent.mjs":"node_modules/@lightningjs/core/src/components/BloomComponent.mjs","./components/SmoothScaleComponent.mjs":"node_modules/@lightningjs/core/src/components/SmoothScaleComponent.mjs","./components/BorderComponent.mjs":"node_modules/@lightningjs/core/src/components/BorderComponent.mjs","./EventEmitter.mjs":"node_modules/@lightningjs/core/src/EventEmitter.mjs","./renderer/webgl/WebGLShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/WebGLShader.mjs","./renderer/webgl/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DefaultShader.mjs","./renderer/common/shaders/GrayscaleShader.mjs":"node_modules/@lightningjs/core/src/renderer/common/shaders/GrayscaleShader.mjs","./renderer/webgl/shaders/BoxBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/BoxBlurShader.mjs","./renderer/webgl/shaders/DitheringShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/DitheringShader.mjs","./renderer/webgl/shaders/CircularPushShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/CircularPushShader.mjs","./renderer/webgl/shaders/InversionShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/InversionShader.mjs","./renderer/webgl/shaders/LinearBlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/LinearBlurShader.mjs","./renderer/webgl/shaders/OutlineShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/OutlineShader.mjs","./renderer/webgl/shaders/PixelateShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/PixelateShader.mjs","./renderer/webgl/shaders/RadialFilterShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RadialFilterShader.mjs","./renderer/webgl/shaders/RoundedRectangleShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RoundedRectangleShader.mjs","./renderer/webgl/shaders/FadeOutShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/FadeOutShader.mjs","./renderer/webgl/shaders/VignetteShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/VignetteShader.mjs","./renderer/webgl/shaders/SpinnerShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/SpinnerShader.mjs","./renderer/webgl/shaders/HoleShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/HoleShader.mjs","./renderer/webgl/shaders/RadialGradientShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/RadialGradientShader.mjs","./renderer/webgl/shaders/Light3dShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/Light3dShader.mjs","./renderer/webgl/shaders/PerspectiveShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/PerspectiveShader.mjs","./renderer/webgl/shaders/MagnifierShader.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/MagnifierShader.mjs","./renderer/c2d/C2dShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/C2dShader.mjs","./renderer/c2d/shaders/DefaultShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/DefaultShader.mjs","./renderer/c2d/shaders/BlurShader.mjs":"node_modules/@lightningjs/core/src/renderer/c2d/shaders/BlurShader.mjs","./tree/Stage.mjs":"node_modules/@lightningjs/core/src/tree/Stage.mjs","./renderer/webgl/shaders/SpinnerShader2.mjs":"node_modules/@lightningjs/core/src/renderer/webgl/shaders/SpinnerShader2.mjs"}],"node_modules/@lightningjs/core/index.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _lightning = _interopRequireDefault(require("./src/lightning.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/*
 * If not stated otherwise in this file or this component's LICENSE file the
 * following copyright and licenses apply:
 ...
 * limitations under the License.
 */
var _default = exports.default = _lightning.default;
},{"./src/lightning.mjs":"node_modules/@lightningjs/core/src/lightning.mjs"}],"src/components/Topnav.js":[function(require,module,exports) {
"use strict";
...
var Topnav = exports.Topnav = /*#__PURE__*/function (_Lightning$Component) {
  _inherits(Topnav, _Lightning$Component);
  var _super = _createSuper(Topnav);
  function Topnav(stage) {
    var _this;
    _classCallCheck(this, Topnav);
    _this = _super.call(this, stage);
    _this.rect = true;
    _this.color = 0x11ffffff;
    _this.w = _.VIEWPORT_WIDTH;
    _this.h = 50;
    _this.focusedIndex = 0;
    _this.elements = [];
    for (var i = 0; i < elements.length; i++) {
      var el = new _core.default.Element(stage);
      var txt = new _core.default.textures.TextTexture(stage);
      el.x = 50 + 200 * i;
      txt.text = elements[i];
      if (i === _this.focusedIndex) {
        el.color = 0xff00ff00;
      } else {
        el.color = 0xffffffff;
      }
  ...
  _createClass(Topnav, [{
    ...
    value: function _handleRight() {
      this.elements[this.focusedIndex].color = 0xffffffff;
      this.focusedIndex = Math.min(this.elements.length - 1, this.focusedIndex + 1);
      this.elements[this.focusedIndex].color = 0xff00ff00;
    }
  }]);
  return Topnav;
}(_core.default.Component);
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","..":"src/index.js"}],"src/components/Tile.js":[function(require,module,exports) {
"use strict";
...
var WIDTH = 16 * 11;
var HEIGHT = 9 * 11;
var Tile = exports.Tile = /*#__PURE__*/function (_Lightning$Component) {
  _inherits(Tile, _Lightning$Component);
...
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js"}],"src/shaders/RoundedRectangleShader/fragment.glsl":[function(require,module,exports) {
...
},{}],"src/shaders/RoundedRectangleShader/index.js":[function(require,module,exports) {
"use strict";
...
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","./fragment.glsl":"src/shaders/RoundedRectangleShader/fragment.glsl"}],"src/components/RoundedTile.js":[function(require,module,exports) {
"use strict";
...
var _RoundedRectangleShader = require("../shaders/RoundedRectangleShader");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var RoundedTile = exports.RoundedTile = /*#__PURE__*/function (_Tile) {
  ...
  function RoundedTile(stage) {
    ...
    _this.shader = stage.renderer.createShader(stage.ctx, {
      type: _RoundedRectangleShader.RoundedRectangleShader
    });
...
},{"./Tile":"src/components/Tile.js","../shaders/RoundedRectangleShader":"src/shaders/RoundedRectangleShader/index.js"}],"src/components/Rail.js":[function(require,module,exports) {
"use strict";
...
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","./Tile":"src/components/Tile.js","./RoundedTile":"src/components/RoundedTile.js"}],"src/components/Content.js":[function(require,module,exports) {
"use strict";
...
var Content = exports.Content = /*#__PURE__*/function (_Lightning$Component) {
  ...
  function Content(stage) {
    ...
    _this.h = 550;
    _this.y = 50;
    _this.color = 0xff1a1a1a;
    _this.rails = [];
    _this.focusedIndex = 0;
    for (var i = 0; i < rails.length; i++) {
      var el = new _Rail.Rail(stage);
      el.y = 50 + 200 * i;
      el.setItems(rails[i]);
      _this.rails.push(el);
      _this.childList.add(el);
...
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","./Rail":"src/components/Rail.js"}],"src/App.js":[function(require,module,exports) {
"use strict";
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var App = exports.default = /*#__PURE__*/function (_Lightning$Component) {
  ...
  function App(stage) {
    ...
    // 1 -> Content focused
    _this.focusedIndex = 0;
    var topNav = _this.topNav = new _Topnav.Topnav(stage);
    var content = _this.content = new _Content.Content(stage);
    _this.childList.add(topNav);
    _this.childList.add(content);
    return _this;
  }
  _createClass(App, [{
    key: "_getFocused",
...
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","./components/Topnav":"src/components/Topnav.js","./components/Content":"src/components/Content.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.VIEWPORT_WIDTH = exports.VIEWPORT_HEIGHT = void 0;
var _core = _interopRequireDefault(require("@lightningjs/core"));
...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var VIEWPORT_WIDTH = exports.VIEWPORT_WIDTH = 1066;
var VIEWPORT_HEIGHT = exports.VIEWPORT_HEIGHT = 600;
var settings = {
  stage: {
    w: VIEWPORT_WIDTH,
    h: VIEWPORT_HEIGHT,
...
var Application = /*#__PURE__*/function (_Lightning$Applicatio) {
  ...
  return Application;
}(_core.default.Application);
var app = new Application(settings);
document.body.appendChild(app.stage.getCanvas());
},{"@lightningjs/core":"node_modules/@lightningjs/core/index.js","./App":"src/App.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
